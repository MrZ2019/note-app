...
var protocal = 'http://'
var host = setting.host || '192.168.3.13:4002'


var config =
{
	baseDataUrl: '/api/getdata',
	pageSize: 5,
	baseAppDataUrl:  '/api/getappdata',
}

config.dataUrl = protocal + host + config.baseDataUrl
config.appDataUrl =  protocal +  host + config.baseAppDataUrl

window.imageFolder = "file:///storage/emulated/0/_noteImages/"
// var config =
// {
